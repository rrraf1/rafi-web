...
const data: { [key: string]: DataItem } = {
  orbit: {
    ...
    text: {
      title: "Orbit - Ekstrakurikuler IT",
      description:
  ...
  eraTunes: {
    ...
    text: {
      title: "EraTunes",
      description:
        "EraTunes adalah website dimana user bisa mendengarkan lagu hits dari berbagai dekade, cukup hanya dengan masuk menggunakan akun spotify mereka",
